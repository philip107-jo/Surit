	...
	<%@ taglib prefix="c" uri="jakarta.tags.core" %>
		...
		<body>
			...
			<dl>
				<dt>접수번호</dt>
				<dd>
					<c:out value="${req.receiptCode}" />
				</dd>
				<dt>제목</dt>
				<dd>
					<c:out value="${req.receiptTitle}" />
				</dd>
				<dt>분야</dt>
				<dd>
					<c:out value="${req.categoryItem}" />
				</dd>
				<dt>모델명</dt>
				<dd>
					<c:out value="${req.modelName}" default="-" />
				</dd>
				<dt>고객</dt>
				<dd>
				...
				<dt>증상</dt>
				<dd>
					<c:out value="${req.receiptDetails}" />
				</dd>
				<dt>접수일</dt>
				<dd>${req.createdAtText}</dd>
			</dl>
