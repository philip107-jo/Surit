...
<header class="site-header">
    <div class="site-header__inner">
        ...
        <c:if test="${ not empty sessionScope.loginMember }">
            <nav class="gnb">
                <a href="${pageContext.request.contextPath}/request/request">수리접수</a>
                    ...
                    <div class="profile" id="profile">
                        ...
                        <div class="profile__menu" id="profile-menu">
                            ...
                            <c:if test="${ sessionScope.loginMember.userRole == 'FIXER' }">
                                <a href="${pageContext.request.contextPath}/fixer/requests" class="switch">
                            ...
                            <a href="${pageContext.request.contextPath}/user/logout" class="logout">
