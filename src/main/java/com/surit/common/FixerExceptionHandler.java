 ...
 * 안내 메시지를 보여주기 위한 핸들러.
 *
 * 위치는 팀 규칙에 따라 com.surit.common 에 두지만, 적용 대상은
 * basePackages 로 기사 기능 패키지만 한정한다. 다른 팀원이 만든
 * 컨트롤러(로그인, 회원가입 등)에는 영향을 주지 않는다.
 *
 * 기사 기능이 여러 패키지로 나뉘어 있어 한 줄로는 좁힐 수 없으므로
 * 네 개를 나열한다. 기사 기능 패키지가 늘어나면 여기에 추가한다.
 */
